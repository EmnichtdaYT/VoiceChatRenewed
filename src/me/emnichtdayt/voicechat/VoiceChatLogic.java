            ...
            for (Entity targetNearby : nearby) {
              if (targetNearby instanceof Player) {
                ...
                if (
                  ...
                  targetNearbyVoice.getCurrentChannel().getUsers().size() <= targetVoice.getCurrentChannel().getUsers().size()
                ) {
        ...
        for (Entity entNearby : nearby) {
          if (entNearby instanceof Player) {
            ...
            if (
              ...
              !setEnt.testState(WorldGuardPlugin.inst().wrapPlayer((Player) entNearby), pl.isDisabledRegion)
            ) {
