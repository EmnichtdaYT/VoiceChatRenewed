...
public class VoicePlayer {
  ...
  public String toString() {
    return "VoicePlayer [" + "state=" + state + ", discordID=" + discordID + ", isAutomaticControlled=" + isAutomaticControlled + "]";
  }
  ...
  /**
   * setAutomaticControlled(boolean isAutomaticControlled) enables or disables
   * VoiceChat's logic for that player.
   *
   * @param boolean isAutomaticControlled
   */
